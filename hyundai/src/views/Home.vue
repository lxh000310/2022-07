  ...
  <el-container style=" border: 0px solid ;height: 97.9vh ">
    <el-aside style="height: auto;width: 200px;background-color:#001528">
      <div class="logo_span" style="height:75px;">
        <div class="logo" style="position: relative;width: 165px;left: 37px;top: 22px">
          <span style="font-size: large;color: white">现代线索平台</span>
        </div>
      </div>
...
<!--                </el-option>-->
<!--              </el-select>-->
              <span style="position: absolute;top: 8px;left: 580px">性别:</span>
              <el-select v-model="sex" placeholder="请选择" style="position:absolute;left: 630px">
                <el-option
          ...
          <el-table :data="tableData">
            ...
            <el-table-column prop="displayCity" label="购车城市" width="250">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      request.get("https://rw.velo.com.cn/xd/api/member/query", {
        params: {
          page: this.page,
    ...
    exportExecl() {
      ...
      window.open(`https://rw.velo.com.cn/xd/api/member/download?&mobile=${this.mobile}&code=${cD}&gender=${this.sex}&token=${window.localStorage.getItem('accessToken')}&endTime=${eT}&beginTime=${bT}&page=1&pageSize=99999`, "_blank")
    },
    // exportExcel() {
